...
class Consulta_Producto(FlaskForm):
    criterio = StringField('Escriba el Nombre del Producto: ', validators=[Length(min=3, max=100, message="Debe ingresar como minimo 3 caracteres"),DataRequired(message="Debe escribir un valor")])
...
#Nuevo usuario y checkeo de contraseñas.
